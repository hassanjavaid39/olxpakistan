...
export default class Dashboard extends Component {
  ...
  showAds = e => {
    if (
      this.state.majorCategory === "Properties" &&
      ...
      (this.state.majorCategory === "Properties" &&
        this.state.category === "all") ||
      this.state.majorCategory === "Properties" ||
      ((this.state.majorCategory === "Cars" && this.state.category === "all") ||
        this.state.majorCategory === "Cars")
    ) {
    ...
    if (token) {
      return (
        <div>
          ...
          <h1
            style={{ width: "80%", margin: "0 auto", padding: "20px 0 20px 0" }}
          >
            Your Ads Will Be Displayed Here, Search By Category
          </h1>
          ...
          >
            <select
              ...
              name="majorCategory"
              value={this.state.majorCategory}
