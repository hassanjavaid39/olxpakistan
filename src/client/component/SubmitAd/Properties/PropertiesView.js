              ...
              >
                <div className="container">
                  ...
                  <h1 className="display-6">
                    {ad.majorCategory} / {ad.category} / {ad.type}
                  </h1>
                  <h1 className="lead">Description: {ad.description}</h1>
                  <div className="container">
                    <div className="row">
                      <div className="col-sm">
                        <span style={{ textDecoration: "900" }}>Price:</span>{" "}
                        {ad.price}
                      </div>
                      <div className="col-sm">Bedroom: {ad.bedrooms}</div>
                      <div className="col-sm">Bathrooms: {ad.bathrooms}</div>
                    </div>
                  </div>
                  <hr />
                  <div className="container">
                    <div className="row">
                      <div className="col-sm">Furnishing: {ad.furnishing}</div>
                      <div className="col-sm">Listed By: {ad.listedby}</div>
                      <div className="col-sm">Super Bed Area: {ad.SBArea}</div>
                    </div>
                  </div>
                  <hr />
                  <div className="container">
                    <div className="row">
                      <div className="col-sm">Carpet Area: {ad.carpetArea}</div>
                      <div className="col-sm">
                  ...
                  <div className="container">
                    <div className="row">
                      ...
                      <div className="col-sm">Car Parking: {ad.carparking}</div>
                    </div>
                  </div>
                  <hr />
                  <div className="container">
                    <div className="row">
                      <div className="col-sm">Facing: {ad.facing}</div>
                      <div className="col-sm">
                        Project Name: {ad.projectname}
                      </div>
                      <div className="col-sm">Location: {ad.location}</div>
                    </div>
                  </div>
                  <hr />
                  <div className="container">
                    <div className="row">
                      <div className="col-sm">Name: {ad.name}</div>
                      <div className="col-sm">Phone: {ad.phone}</div>
                  ...
                  <div className="container">
                    <div className="row">
                      <div className="col-sm">
                        {currentUser === ad.userId ? (
                          <div>
                            {" "}
                            {this.renderRedirect()}{" "}
                            <button
                              onClick={() => this.setRedirect(ad)}
