...
mongoose.connect(
  "mongodb://hassan:tanol1@ds151282.mlab.com:51282/olxpakistan",
  {
    auth: {
      user: "hassan",
      password: "tanol1"
    ...
    admin
      ...
      .then(function() {
        webpush.setVapidDetails(
          "mailto:razzyshaikh@gmail.com",
          "BM1esoY0GA0p2oaqBQUr8AgWpiLg0ZvTv99JtwSUJWLw3JZrw0fQ_g0fY2IUaTpTziy8RZQe7A154AM-P4yE_xg",
          "hQMRQaS_hXtWHhLEap0hP2mYEruTuxbzJO72LZIB8J4"
        );
        return admin
          .database()
          .ref("subscriptions")
